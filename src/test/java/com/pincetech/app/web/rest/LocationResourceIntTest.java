...
import com.pincetech.app.repository.LocationRepository;
import com.pincetech.app.service.LocationService;
import com.pincetech.app.repository.search.LocationSearchRepository;
import com.pincetech.app.service.dto.LocationDTO;
import com.pincetech.app.service.mapper.LocationMapper;
...
public class LocationResourceIntTest {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getStreetAddress1()).isEqualTo(DEFAULT_STREET_ADDRESS_1);
        assertThat(testLocation.getStreetAddress2()).isEqualTo(DEFAULT_STREET_ADDRESS_2);
    ...
    public void updateLocation() throws Exception {
        ...
        Location testLocation = locations.get(locations.size() - 1);
        assertThat(testLocation.getStreetAddress1()).isEqualTo(UPDATED_STREET_ADDRESS_1);
        assertThat(testLocation.getStreetAddress2()).isEqualTo(UPDATED_STREET_ADDRESS_2);
